# 1. Fetch available AZs dynamically in the chosen region
...
# 3. Create Public Subnets (AZ 1 & AZ 2)
...
# 4. Create Private Subnets (AZ 1 & AZ 2)
...
# 3. Create a brand new Route Table for the Private Subnets
...
# 4. Associate BOTH Private Subnets to the Private Route Table
